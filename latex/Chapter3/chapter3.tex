...
\begin{figure}[p]
 \centering
 \includegraphics[width=0.9\textwidth]{306_secondary_objects_error}
 \caption{
...
\begin{figure}[p]
 \centering
 \includegraphics[width=0.9\textwidth]{307_blow_lasso}
 \caption{
 	Blow tool
 }
 \label{fig:blow}
...
\begin{figure}[p]
 \centering
 \includegraphics[width=0.9\textwidth]{308_bf_profiles}
 \caption{
 	Brightfield profile
 }
